...
function ci_Catena-Arduino-Platform_generic {
    ...
    for iSketch in "$@"; do
        ...
        MCCI_CI_FILTER_NAME="$(dirname "$iSketch")/extra/ci/Catena-Arduino-Platform-filter.sh"
...
function ci_samd {
    ...
    ci_Catena-Arduino-Platform_generic "$@"
}
